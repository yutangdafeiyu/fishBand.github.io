const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomeView-CP3Fo4ns.js","assets/AppLayout-koFaqDo5.js","assets/three-core-a6RBWivb.js","assets/AppLayout-BETnAcZD.css","assets/gsap-CB87Sc6I.js","assets/marked-BOcXoNEU.js","assets/HomeView-zy1I1OFY.css","assets/ArticleView-cT80A6eN.js","assets/ArticleView-DllktBSa.css"])))=>i.map(i=>d[i]);
import{r as ge,m as he,e as fe,c as F,i as gn,a as Dn,t as Fe,b as ve,d as Z,h as qe,g as Ue,o as ze,f as be,n as xe,j as We,w as ye,u as un,s as Ge,k as $e,l as je,p as we,q as kn,v as zn,x as Ye,y as Wn,z as Gn,A as Je,T as Ke,B as Xe,C as Qe}from"./three-core-a6RBWivb.js";import{M as Ze}from"./marked-BOcXoNEU.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();/*!
 * pinia v2.3.1
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let Re;const bn=n=>Re=n,Pe=Symbol();function En(n){return n&&typeof n=="object"&&Object.prototype.toString.call(n)==="[object Object]"&&typeof n.toJSON!="function"}var dn;(function(n){n.direct="direct",n.patchObject="patch object",n.patchFunction="patch function"})(dn||(dn={}));function nt(){const n=fe(!0),e=n.run(()=>ge({}));let t=[],s=[];const o=he({install(r){bn(o),o._a=r,r.provide(Pe,o),r.config.globalProperties.$pinia=o,s.forEach(a=>t.push(a)),s=[]},use(r){return this._a?t.push(r):s.push(r),this},_p:t,_a:null,_e:n,_s:new Map,state:e});return o}const ke=()=>{};function $n(n,e,t,s=ke){n.push(e);const o=()=>{const r=n.indexOf(e);r>-1&&(n.splice(r,1),s())};return!t&&Ue()&&ze(o),o}function en(n,...e){n.slice().forEach(t=>{t(...e)})}const et=n=>n(),Yn=Symbol(),Sn=Symbol();function Bn(n,e){n instanceof Map&&e instanceof Map?e.forEach((t,s)=>n.set(s,t)):n instanceof Set&&e instanceof Set&&e.forEach(n.add,n);for(const t in e){if(!e.hasOwnProperty(t))continue;const s=e[t],o=n[t];En(o)&&En(s)&&n.hasOwnProperty(t)&&!gn(s)&&!Dn(s)?n[t]=Bn(o,s):n[t]=s}return n}const tt=Symbol();function st(n){return!En(n)||!n.hasOwnProperty(tt)}const{assign:K}=Object;function ot(n){return!!(gn(n)&&n.effect)}function rt(n,e,t,s){const{state:o,actions:r,getters:a}=e,d=t.state.value[n];let c;function p(){d||(t.state.value[n]=o?o():{});const g=We(t.state.value[n]);return K(g,r,Object.keys(a||{}).reduce((i,u)=>(i[u]=he(F(()=>{bn(t);const m=t._s.get(n);return a[u].call(m,m)})),i),{}))}return c=Se(n,p,e,t,s,!0),c}function Se(n,e,t={},s,o,r){let a;const d=K({actions:{}},t),c={deep:!0};let p,g,i=[],u=[],m;const b=s.state.value[n];!r&&!b&&(s.state.value[n]={});let R;function I(A){let P;p=g=!1,typeof A=="function"?(A(s.state.value[n]),P={type:dn.patchFunction,storeId:n,events:m}):(Bn(s.state.value[n],A),P={type:dn.patchObject,payload:A,storeId:n,events:m});const D=R=Symbol();xe().then(()=>{R===D&&(p=!0)}),g=!0,en(i,P,s.state.value[n])}const _=r?function(){const{state:P}=t,D=P?P():{};this.$patch(z=>{K(z,D)})}:ke;function y(){a.stop(),i=[],u=[],s._s.delete(n)}const k=(A,P="")=>{if(Yn in A)return A[Sn]=P,A;const D=function(){bn(s);const z=Array.from(arguments),$=[],W=[];function yn(V){$.push(V)}function an(V){W.push(V)}en(u,{args:z,name:D[Sn],store:N,after:yn,onError:an});let Y;try{Y=A.apply(this&&this.$id===n?this:N,z)}catch(V){throw en(W,V),V}return Y instanceof Promise?Y.then(V=>(en($,V),V)).catch(V=>(en(W,V),Promise.reject(V))):(en($,Y),Y)};return D[Yn]=!0,D[Sn]=P,D},M={_p:s,$id:n,$onAction:$n.bind(null,u),$patch:I,$reset:_,$subscribe(A,P={}){const D=$n(i,A,P.detached,()=>z()),z=a.run(()=>ye(()=>s.state.value[n],$=>{(P.flush==="sync"?g:p)&&A({storeId:n,type:dn.direct,events:m},$)},K({},c,P)));return D},$dispose:y},N=be(M);s._s.set(n,N);const L=(s._a&&s._a.runWithContext||et)(()=>s._e.run(()=>(a=fe()).run(()=>e({action:k}))));for(const A in L){const P=L[A];if(gn(P)&&!ot(P)||Dn(P))r||(b&&st(P)&&(gn(P)?P.value=b[A]:Bn(P,b[A])),s.state.value[n][A]=P);else if(typeof P=="function"){const D=k(P,A);L[A]=D,d.actions[A]=P}}return K(N,L),K(ve(N),L),Object.defineProperty(N,"$state",{get:()=>s.state.value[n],set:A=>{I(P=>{K(P,A)})}}),s._p.forEach(A=>{K(N,a.run(()=>A({store:N,app:s._a,pinia:s,options:d})))}),b&&r&&t.hydrate&&t.hydrate(N.$state,b),p=!0,g=!0,N}/*! #__NO_SIDE_EFFECTS__ */function po(n,e,t){let s,o;const r=typeof e=="function";typeof n=="string"?(s=n,o=r?t:e):(o=n,s=n.id);function a(d,c){const p=qe();return d=d||(p?Z(Pe,null):null),d&&bn(d),d=Re,d._s.has(s)||(r?Se(s,e,o,d):rt(s,o,d)),d._s.get(s)}return a.$id=s,a}function uo(n){{const e=ve(n),t={};for(const s in e){const o=e[s];o.effect?t[s]=F({get:()=>n[s],set(r){n[s]=r}}):(gn(o)||Dn(o))&&(t[s]=Fe(n,s))}return t}}const at="modulepreload",it=function(n){return"/"+n},Jn={},Kn=function(e,t,s){let o=Promise.resolve();if(t&&t.length>0){let a=function(p){return Promise.all(p.map(g=>Promise.resolve(g).then(i=>({status:"fulfilled",value:i}),i=>({status:"rejected",reason:i}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),c=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));o=a(t.map(p=>{if(p=it(p),p in Jn)return;Jn[p]=!0;const g=p.endsWith(".css"),i=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${i}`))return;const u=document.createElement("link");if(u.rel=g?"stylesheet":at,g||(u.as="script"),u.crossOrigin="",u.href=p,c&&u.setAttribute("nonce",c),document.head.appendChild(u),g)return new Promise((m,b)=>{u.addEventListener("load",m),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${p}`)))})}))}function r(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return o.then(a=>{for(const d of a||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})};/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */const tn=typeof document<"u";function Ae(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function lt(n){return n.__esModule||n[Symbol.toStringTag]==="Module"||n.default&&Ae(n.default)}const S=Object.assign;function An(n,e){const t={};for(const s in e){const o=e[s];t[s]=q(o)?o.map(n):n(o)}return t}const mn=()=>{},q=Array.isArray;function Xn(n,e){const t={};for(const s in n)t[s]=s in e?e[s]:n[s];return t}const Ie=/#/g,ct=/&/g,pt=/\//g,ut=/=/g,dt=/\?/g,_e=/\+/g,mt=/%5B/g,gt=/%5D/g,Ce=/%5E/g,ht=/%60/g,Ee=/%7B/g,ft=/%7C/g,Be=/%7D/g,vt=/%20/g;function On(n){return n==null?"":encodeURI(""+n).replace(ft,"|").replace(mt,"[").replace(gt,"]")}function bt(n){return On(n).replace(Ee,"{").replace(Be,"}").replace(Ce,"^")}function Tn(n){return On(n).replace(_e,"%2B").replace(vt,"+").replace(Ie,"%23").replace(ct,"%26").replace(ht,"`").replace(Ee,"{").replace(Be,"}").replace(Ce,"^")}function xt(n){return Tn(n).replace(ut,"%3D")}function yt(n){return On(n).replace(Ie,"%23").replace(dt,"%3F")}function jt(n){return yt(n).replace(pt,"%2F")}function hn(n){if(n==null)return null;try{return decodeURIComponent(""+n)}catch{}return""+n}const wt=/\/$/,Rt=n=>n.replace(wt,"");function In(n,e,t="/"){let s,o={},r="",a="";const d=e.indexOf("#");let c=e.indexOf("?");return c=d>=0&&c>d?-1:c,c>=0&&(s=e.slice(0,c),r=e.slice(c,d>0?d:e.length),o=n(r.slice(1))),d>=0&&(s=s||e.slice(0,d),a=e.slice(d,e.length)),s=At(s??e,t),{fullPath:s+r+a,path:s,query:o,hash:hn(a)}}function Pt(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function Qn(n,e){return!e||!n.toLowerCase().startsWith(e.toLowerCase())?n:n.slice(e.length)||"/"}function kt(n,e,t){const s=e.matched.length-1,o=t.matched.length-1;return s>-1&&s===o&&sn(e.matched[s],t.matched[o])&&Te(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function sn(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function Te(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(var t in n)if(!St(n[t],e[t]))return!1;return!0}function St(n,e){return q(n)?Zn(n,e):q(e)?Zn(e,n):(n==null?void 0:n.valueOf())===(e==null?void 0:e.valueOf())}function Zn(n,e){return q(e)?n.length===e.length&&n.every((t,s)=>t===e[s]):n.length===1&&n[0]===e}function At(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),s=n.split("/"),o=s[s.length-1];(o===".."||o===".")&&s.push("");let r=t.length-1,a,d;for(a=0;a<s.length;a++)if(d=s[a],d!==".")if(d==="..")r>1&&r--;else break;return t.slice(0,r).join("/")+"/"+s.slice(a).join("/")}const J={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Nn=(function(n){return n.pop="pop",n.push="push",n})({}),_n=(function(n){return n.back="back",n.forward="forward",n.unknown="",n})({});function It(n){if(!n)if(tn){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),Rt(n)}const _t=/^[^#]+#/;function Ct(n,e){return n.replace(_t,"#")+e}function Et(n,e){const t=document.documentElement.getBoundingClientRect(),s=n.getBoundingClientRect();return{behavior:e.behavior,left:s.left-t.left-(e.left||0),top:s.top-t.top-(e.top||0)}}const xn=()=>({left:window.scrollX,top:window.scrollY});function Bt(n){let e;if("el"in n){const t=n.el,s=typeof t=="string"&&t.startsWith("#"),o=typeof t=="string"?s?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!o)return;e=Et(o,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function ne(n,e){return(history.state?history.state.position-e:-1)+n}const Ln=new Map;function Tt(n,e){Ln.set(n,e)}function Nt(n){const e=Ln.get(n);return Ln.delete(n),e}function Lt(n){return typeof n=="string"||n&&typeof n=="object"}function Ne(n){return typeof n=="string"||typeof n=="symbol"}let C=(function(n){return n[n.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",n[n.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",n[n.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",n[n.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",n[n.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",n})({});const Le=Symbol("");C.MATCHER_NOT_FOUND+"",C.NAVIGATION_GUARD_REDIRECT+"",C.NAVIGATION_ABORTED+"",C.NAVIGATION_CANCELLED+"",C.NAVIGATION_DUPLICATED+"";function on(n,e){return S(new Error,{type:n,[Le]:!0},e)}function G(n,e){return n instanceof Error&&Le in n&&(e==null||!!(n.type&e))}const Vt=["params","query","hash"];function Dt(n){if(typeof n=="string")return n;if(n.path!=null)return n.path;const e={};for(const t of Vt)t in n&&(e[t]=n[t]);return JSON.stringify(e,null,2)}function Ot(n){const e={};if(n===""||n==="?")return e;const t=(n[0]==="?"?n.slice(1):n).split("&");for(let s=0;s<t.length;++s){const o=t[s].replace(_e," "),r=o.indexOf("="),a=hn(r<0?o:o.slice(0,r)),d=r<0?null:hn(o.slice(r+1));if(a in e){let c=e[a];q(c)||(c=e[a]=[c]),c.push(d)}else e[a]=d}return e}function ee(n){let e="";for(let t in n){const s=n[t];if(t=xt(t),s==null){s!==void 0&&(e+=(e.length?"&":"")+t);continue}(q(s)?s.map(o=>o&&Tn(o)):[s&&Tn(s)]).forEach(o=>{o!==void 0&&(e+=(e.length?"&":"")+t,o!=null&&(e+="="+o))})}return e}function Ht(n){const e={};for(const t in n){const s=n[t];s!==void 0&&(e[t]=q(s)?s.map(o=>o==null?null:""+o):s==null?s:""+s)}return e}const Mt=Symbol(""),te=Symbol(""),Hn=Symbol(""),Mn=Symbol(""),Vn=Symbol("");function pn(){let n=[];function e(s){return n.push(s),()=>{const o=n.indexOf(s);o>-1&&n.splice(o,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function X(n,e,t,s,o,r=a=>a()){const a=s&&(s.enterCallbacks[o]=s.enterCallbacks[o]||[]);return()=>new Promise((d,c)=>{const p=u=>{u===!1?c(on(C.NAVIGATION_ABORTED,{from:t,to:e})):u instanceof Error?c(u):Lt(u)?c(on(C.NAVIGATION_GUARD_REDIRECT,{from:e,to:u})):(a&&s.enterCallbacks[o]===a&&typeof u=="function"&&a.push(u),d())},g=r(()=>n.call(s&&s.instances[o],e,t,p));let i=Promise.resolve(g);n.length<3&&(i=i.then(p)),i.catch(u=>c(u))})}function Cn(n,e,t,s,o=r=>r()){const r=[];for(const a of n)for(const d in a.components){let c=a.components[d];if(!(e!=="beforeRouteEnter"&&!a.instances[d]))if(Ae(c)){const p=(c.__vccOpts||c)[e];p&&r.push(X(p,t,s,a,d,o))}else{let p=c();r.push(()=>p.then(g=>{if(!g)throw new Error(`Couldn't resolve component "${d}" at "${a.path}"`);const i=lt(g)?g.default:g;a.mods[d]=g,a.components[d]=i;const u=(i.__vccOpts||i)[e];return u&&X(u,t,s,a,d,o)()}))}}return r}function Ft(n,e){const t=[],s=[],o=[],r=Math.max(e.matched.length,n.matched.length);for(let a=0;a<r;a++){const d=e.matched[a];d&&(n.matched.find(p=>sn(p,d))?s.push(d):t.push(d));const c=n.matched[a];c&&(e.matched.find(p=>sn(p,c))||o.push(c))}return[t,s,o]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let qt=()=>location.protocol+"//"+location.host;function Ve(n,e){const{pathname:t,search:s,hash:o}=e,r=n.indexOf("#");if(r>-1){let a=o.includes(n.slice(r))?n.slice(r).length:1,d=o.slice(a);return d[0]!=="/"&&(d="/"+d),Qn(d,"")}return Qn(t,n)+s+o}function Ut(n,e,t,s){let o=[],r=[],a=null;const d=({state:u})=>{const m=Ve(n,location),b=t.value,R=e.value;let I=0;if(u){if(t.value=m,e.value=u,a&&a===b){a=null;return}I=R?u.position-R.position:0}else s(m);o.forEach(_=>{_(t.value,b,{delta:I,type:Nn.pop,direction:I?I>0?_n.forward:_n.back:_n.unknown})})};function c(){a=t.value}function p(u){o.push(u);const m=()=>{const b=o.indexOf(u);b>-1&&o.splice(b,1)};return r.push(m),m}function g(){if(document.visibilityState==="hidden"){const{history:u}=window;if(!u.state)return;u.replaceState(S({},u.state,{scroll:xn()}),"")}}function i(){for(const u of r)u();r=[],window.removeEventListener("popstate",d),window.removeEventListener("pagehide",g),document.removeEventListener("visibilitychange",g)}return window.addEventListener("popstate",d),window.addEventListener("pagehide",g),document.addEventListener("visibilitychange",g),{pauseListeners:c,listen:p,destroy:i}}function se(n,e,t,s=!1,o=!1){return{back:n,current:e,forward:t,replaced:s,position:window.history.length,scroll:o?xn():null}}function zt(n){const{history:e,location:t}=window,s={value:Ve(n,t)},o={value:e.state};o.value||r(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function r(c,p,g){const i=n.indexOf("#"),u=i>-1?(t.host&&document.querySelector("base")?n:n.slice(i))+c:qt()+n+c;try{e[g?"replaceState":"pushState"](p,"",u),o.value=p}catch(m){console.error(m),t[g?"replace":"assign"](u)}}function a(c,p){r(c,S({},e.state,se(o.value.back,c,o.value.forward,!0),p,{position:o.value.position}),!0),s.value=c}function d(c,p){const g=S({},o.value,e.state,{forward:c,scroll:xn()});r(g.current,g,!0),r(c,S({},se(s.value,c,null),{position:g.position+1},p),!1),s.value=c}return{location:s,state:o,push:d,replace:a}}function Wt(n){n=It(n);const e=zt(n),t=Ut(n,e.state,e.location,e.replace);function s(r,a=!0){a||t.pauseListeners(),history.go(r)}const o=S({location:"",base:n,go:s,createHref:Ct.bind(null,n)},e,t);return Object.defineProperty(o,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(o,"state",{enumerable:!0,get:()=>e.state.value}),o}function Gt(n){return n=location.host?n||location.pathname+location.search:"",n.includes("#")||(n+="#"),Wt(n)}let Q=(function(n){return n[n.Static=0]="Static",n[n.Param=1]="Param",n[n.Group=2]="Group",n})({});var T=(function(n){return n[n.Static=0]="Static",n[n.Param=1]="Param",n[n.ParamRegExp=2]="ParamRegExp",n[n.ParamRegExpEnd=3]="ParamRegExpEnd",n[n.EscapeNext=4]="EscapeNext",n})(T||{});const $t={type:Q.Static,value:""},Yt=/[a-zA-Z0-9_]/;function Jt(n){if(!n)return[[]];if(n==="/")return[[$t]];if(!n.startsWith("/"))throw new Error(`Invalid path "${n}"`);function e(m){throw new Error(`ERR (${t})/"${p}": ${m}`)}let t=T.Static,s=t;const o=[];let r;function a(){r&&o.push(r),r=[]}let d=0,c,p="",g="";function i(){p&&(t===T.Static?r.push({type:Q.Static,value:p}):t===T.Param||t===T.ParamRegExp||t===T.ParamRegExpEnd?(r.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${p}) must be alone in its segment. eg: '/:ids+.`),r.push({type:Q.Param,value:p,regexp:g,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),p="")}function u(){p+=c}for(;d<n.length;){if(c=n[d++],c==="\\"&&t!==T.ParamRegExp){s=t,t=T.EscapeNext;continue}switch(t){case T.Static:c==="/"?(p&&i(),a()):c===":"?(i(),t=T.Param):u();break;case T.EscapeNext:u(),t=s;break;case T.Param:c==="("?t=T.ParamRegExp:Yt.test(c)?u():(i(),t=T.Static,c!=="*"&&c!=="?"&&c!=="+"&&d--);break;case T.ParamRegExp:c===")"?g[g.length-1]=="\\"?g=g.slice(0,-1)+c:t=T.ParamRegExpEnd:g+=c;break;case T.ParamRegExpEnd:i(),t=T.Static,c!=="*"&&c!=="?"&&c!=="+"&&d--,g="";break;default:e("Unknown state");break}}return t===T.ParamRegExp&&e(`Unfinished custom RegExp for param "${p}"`),i(),a(),o}const oe="[^/]+?",Kt={sensitive:!1,strict:!1,start:!0,end:!0};var O=(function(n){return n[n._multiplier=10]="_multiplier",n[n.Root=90]="Root",n[n.Segment=40]="Segment",n[n.SubSegment=30]="SubSegment",n[n.Static=40]="Static",n[n.Dynamic=20]="Dynamic",n[n.BonusCustomRegExp=10]="BonusCustomRegExp",n[n.BonusWildcard=-50]="BonusWildcard",n[n.BonusRepeatable=-20]="BonusRepeatable",n[n.BonusOptional=-8]="BonusOptional",n[n.BonusStrict=.7000000000000001]="BonusStrict",n[n.BonusCaseSensitive=.25]="BonusCaseSensitive",n})(O||{});const Xt=/[.+*?^${}()[\]/\\]/g;function Qt(n,e){const t=S({},Kt,e),s=[];let o=t.start?"^":"";const r=[];for(const p of n){const g=p.length?[]:[O.Root];t.strict&&!p.length&&(o+="/");for(let i=0;i<p.length;i++){const u=p[i];let m=O.Segment+(t.sensitive?O.BonusCaseSensitive:0);if(u.type===Q.Static)i||(o+="/"),o+=u.value.replace(Xt,"\\$&"),m+=O.Static;else if(u.type===Q.Param){const{value:b,repeatable:R,optional:I,regexp:_}=u;r.push({name:b,repeatable:R,optional:I});const y=_||oe;if(y!==oe){m+=O.BonusCustomRegExp;try{`${y}`}catch(M){throw new Error(`Invalid custom RegExp for param "${b}" (${y}): `+M.message)}}let k=R?`((?:${y})(?:/(?:${y}))*)`:`(${y})`;i||(k=I&&p.length<2?`(?:/${k})`:"/"+k),I&&(k+="?"),o+=k,m+=O.Dynamic,I&&(m+=O.BonusOptional),R&&(m+=O.BonusRepeatable),y===".*"&&(m+=O.BonusWildcard)}g.push(m)}s.push(g)}if(t.strict&&t.end){const p=s.length-1;s[p][s[p].length-1]+=O.BonusStrict}t.strict||(o+="/?"),t.end?o+="$":t.strict&&!o.endsWith("/")&&(o+="(?:/|$)");const a=new RegExp(o,t.sensitive?"":"i");function d(p){const g=p.match(a),i={};if(!g)return null;for(let u=1;u<g.length;u++){const m=g[u]||"",b=r[u-1];i[b.name]=m&&b.repeatable?m.split("/"):m}return i}function c(p){let g="",i=!1;for(const u of n){(!i||!g.endsWith("/"))&&(g+="/"),i=!1;for(const m of u)if(m.type===Q.Static)g+=m.value;else if(m.type===Q.Param){const{value:b,repeatable:R,optional:I}=m,_=b in p?p[b]:"";if(q(_)&&!R)throw new Error(`Provided param "${b}" is an array but it is not repeatable (* or + modifiers)`);const y=q(_)?_.join("/"):_;if(!y)if(I)u.length<2&&(g.endsWith("/")?g=g.slice(0,-1):i=!0);else throw new Error(`Missing required param "${b}"`);g+=y}}return g||"/"}return{re:a,score:s,keys:r,parse:d,stringify:c}}function Zt(n,e){let t=0;for(;t<n.length&&t<e.length;){const s=e[t]-n[t];if(s)return s;t++}return n.length<e.length?n.length===1&&n[0]===O.Static+O.Segment?-1:1:n.length>e.length?e.length===1&&e[0]===O.Static+O.Segment?1:-1:0}function De(n,e){let t=0;const s=n.score,o=e.score;for(;t<s.length&&t<o.length;){const r=Zt(s[t],o[t]);if(r)return r;t++}if(Math.abs(o.length-s.length)===1){if(re(s))return 1;if(re(o))return-1}return o.length-s.length}function re(n){const e=n[n.length-1];return n.length>0&&e[e.length-1]<0}const ns={strict:!1,end:!0,sensitive:!1};function es(n,e,t){const s=Qt(Jt(n.path),t),o=S(s,{record:n,parent:e,children:[],alias:[]});return e&&!o.record.aliasOf==!e.record.aliasOf&&e.children.push(o),o}function ts(n,e){const t=[],s=new Map;e=Xn(ns,e);function o(i){return s.get(i)}function r(i,u,m){const b=!m,R=ie(i);R.aliasOf=m&&m.record;const I=Xn(e,i),_=[R];if("alias"in i){const M=typeof i.alias=="string"?[i.alias]:i.alias;for(const N of M)_.push(ie(S({},R,{components:m?m.record.components:R.components,path:N,aliasOf:m?m.record:R})))}let y,k;for(const M of _){const{path:N}=M;if(u&&N[0]!=="/"){const U=u.record.path,L=U[U.length-1]==="/"?"":"/";M.path=u.record.path+(N&&L+N)}if(y=es(M,u,I),m?m.alias.push(y):(k=k||y,k!==y&&k.alias.push(y),b&&i.name&&!le(y)&&a(i.name)),Oe(y)&&c(y),R.children){const U=R.children;for(let L=0;L<U.length;L++)r(U[L],y,m&&m.children[L])}m=m||y}return k?()=>{a(k)}:mn}function a(i){if(Ne(i)){const u=s.get(i);u&&(s.delete(i),t.splice(t.indexOf(u),1),u.children.forEach(a),u.alias.forEach(a))}else{const u=t.indexOf(i);u>-1&&(t.splice(u,1),i.record.name&&s.delete(i.record.name),i.children.forEach(a),i.alias.forEach(a))}}function d(){return t}function c(i){const u=rs(i,t);t.splice(u,0,i),i.record.name&&!le(i)&&s.set(i.record.name,i)}function p(i,u){let m,b={},R,I;if("name"in i&&i.name){if(m=s.get(i.name),!m)throw on(C.MATCHER_NOT_FOUND,{location:i});I=m.record.name,b=S(ae(u.params,m.keys.filter(k=>!k.optional).concat(m.parent?m.parent.keys.filter(k=>k.optional):[]).map(k=>k.name)),i.params&&ae(i.params,m.keys.map(k=>k.name))),R=m.stringify(b)}else if(i.path!=null)R=i.path,m=t.find(k=>k.re.test(R)),m&&(b=m.parse(R),I=m.record.name);else{if(m=u.name?s.get(u.name):t.find(k=>k.re.test(u.path)),!m)throw on(C.MATCHER_NOT_FOUND,{location:i,currentLocation:u});I=m.record.name,b=S({},u.params,i.params),R=m.stringify(b)}const _=[];let y=m;for(;y;)_.unshift(y.record),y=y.parent;return{name:I,path:R,params:b,matched:_,meta:os(_)}}n.forEach(i=>r(i));function g(){t.length=0,s.clear()}return{addRoute:r,resolve:p,removeRoute:a,clearRoutes:g,getRoutes:d,getRecordMatcher:o}}function ae(n,e){const t={};for(const s of e)s in n&&(t[s]=n[s]);return t}function ie(n){const e={path:n.path,redirect:n.redirect,name:n.name,meta:n.meta||{},aliasOf:n.aliasOf,beforeEnter:n.beforeEnter,props:ss(n),children:n.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in n?n.components||null:n.component&&{default:n.component}};return Object.defineProperty(e,"mods",{value:{}}),e}function ss(n){const e={},t=n.props||!1;if("component"in n)e.default=t;else for(const s in n.components)e[s]=typeof t=="object"?t[s]:t;return e}function le(n){for(;n;){if(n.record.aliasOf)return!0;n=n.parent}return!1}function os(n){return n.reduce((e,t)=>S(e,t.meta),{})}function rs(n,e){let t=0,s=e.length;for(;t!==s;){const r=t+s>>1;De(n,e[r])<0?s=r:t=r+1}const o=as(n);return o&&(s=e.lastIndexOf(o,s-1)),s}function as(n){let e=n;for(;e=e.parent;)if(Oe(e)&&De(n,e)===0)return e}function Oe({record:n}){return!!(n.name||n.components&&Object.keys(n.components).length||n.redirect)}function ce(n){const e=Z(Hn),t=Z(Mn),s=F(()=>{const c=un(n.to);return e.resolve(c)}),o=F(()=>{const{matched:c}=s.value,{length:p}=c,g=c[p-1],i=t.matched;if(!g||!i.length)return-1;const u=i.findIndex(sn.bind(null,g));if(u>-1)return u;const m=pe(c[p-2]);return p>1&&pe(g)===m&&i[i.length-1].path!==m?i.findIndex(sn.bind(null,c[p-2])):u}),r=F(()=>o.value>-1&&us(t.params,s.value.params)),a=F(()=>o.value>-1&&o.value===t.matched.length-1&&Te(t.params,s.value.params));function d(c={}){if(ps(c)){const p=e[un(n.replace)?"replace":"push"](un(n.to)).catch(mn);return n.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>p),p}return Promise.resolve()}return{route:s,href:F(()=>s.value.href),isActive:r,isExactActive:a,navigate:d}}function is(n){return n.length===1?n[0]:n}const ls=je({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:ce,setup(n,{slots:e}){const t=be(ce(n)),{options:s}=Z(Hn),o=F(()=>({[ue(n.activeClass,s.linkActiveClass,"router-link-active")]:t.isActive,[ue(n.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:t.isExactActive}));return()=>{const r=e.default&&is(e.default(t));return n.custom?r:we("a",{"aria-current":t.isExactActive?n.ariaCurrentValue:null,href:t.href,onClick:t.navigate,class:o.value},r)}}}),cs=ls;function ps(n){if(!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)&&!n.defaultPrevented&&!(n.button!==void 0&&n.button!==0)){if(n.currentTarget&&n.currentTarget.getAttribute){const e=n.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return n.preventDefault&&n.preventDefault(),!0}}function us(n,e){for(const t in e){const s=e[t],o=n[t];if(typeof s=="string"){if(s!==o)return!1}else if(!q(o)||o.length!==s.length||s.some((r,a)=>r.valueOf()!==o[a].valueOf()))return!1}return!0}function pe(n){return n?n.aliasOf?n.aliasOf.path:n.path:""}const ue=(n,e,t)=>n??e??t,ds=je({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(n,{attrs:e,slots:t}){const s=Z(Vn),o=F(()=>n.route||s.value),r=Z(te,0),a=F(()=>{let p=un(r);const{matched:g}=o.value;let i;for(;(i=g[p])&&!i.components;)p++;return p}),d=F(()=>o.value.matched[a.value]);kn(te,F(()=>a.value+1)),kn(Mt,d),kn(Vn,o);const c=ge();return ye(()=>[c.value,d.value,n.name],([p,g,i],[u,m,b])=>{g&&(g.instances[i]=p,m&&m!==g&&p&&p===u&&(g.leaveGuards.size||(g.leaveGuards=m.leaveGuards),g.updateGuards.size||(g.updateGuards=m.updateGuards))),p&&g&&(!m||!sn(g,m)||!u)&&(g.enterCallbacks[i]||[]).forEach(R=>R(p))},{flush:"post"}),()=>{const p=o.value,g=n.name,i=d.value,u=i&&i.components[g];if(!u)return de(t.default,{Component:u,route:p});const m=i.props[g],b=m?m===!0?p.params:typeof m=="function"?m(p):m:null,I=we(u,S({},b,e,{onVnodeUnmounted:_=>{_.component.isUnmounted&&(i.instances[g]=null)},ref:c}));return de(t.default,{Component:I,route:p})||I}}});function de(n,e){if(!n)return null;const t=n(e);return t.length===1?t[0]:t}const ms=ds;function gs(n){const e=ts(n.routes,n),t=n.parseQuery||Ot,s=n.stringifyQuery||ee,o=n.history,r=pn(),a=pn(),d=pn(),c=$e(J);let p=J;tn&&n.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const g=An.bind(null,l=>""+l),i=An.bind(null,jt),u=An.bind(null,hn);function m(l,f){let h,v;return Ne(l)?(h=e.getRecordMatcher(l),v=f):v=l,e.addRoute(v,h)}function b(l){const f=e.getRecordMatcher(l);f&&e.removeRoute(f)}function R(){return e.getRoutes().map(l=>l.record)}function I(l){return!!e.getRecordMatcher(l)}function _(l,f){if(f=S({},f||c.value),typeof l=="string"){const x=In(t,l,f.path),B=e.resolve({path:x.path},f),cn=o.createHref(x.fullPath);return S(x,B,{params:u(B.params),hash:hn(x.hash),redirectedFrom:void 0,href:cn})}let h;if(l.path!=null)h=S({},l,{path:In(t,l.path,f.path).path});else{const x=S({},l.params);for(const B in x)x[B]==null&&delete x[B];h=S({},l,{params:i(x)}),f.params=i(f.params)}const v=e.resolve(h,f),w=l.hash||"";v.params=g(u(v.params));const E=Pt(s,S({},l,{hash:bt(w),path:v.path})),j=o.createHref(E);return S({fullPath:E,hash:w,query:s===ee?Ht(l.query):l.query||{}},v,{redirectedFrom:void 0,href:j})}function y(l){return typeof l=="string"?In(t,l,c.value.path):S({},l)}function k(l,f){if(p!==l)return on(C.NAVIGATION_CANCELLED,{from:f,to:l})}function M(l){return L(l)}function N(l){return M(S(y(l),{replace:!0}))}function U(l,f){const h=l.matched[l.matched.length-1];if(h&&h.redirect){const{redirect:v}=h;let w=typeof v=="function"?v(l,f):v;return typeof w=="string"&&(w=w.includes("?")||w.includes("#")?w=y(w):{path:w},w.params={}),S({query:l.query,hash:l.hash,params:w.path!=null?{}:l.params},w)}}function L(l,f){const h=p=_(l),v=c.value,w=l.state,E=l.force,j=l.replace===!0,x=U(h,v);if(x)return L(S(y(x),{state:typeof x=="object"?S({},w,x.state):w,force:E,replace:j}),f||h);const B=h;B.redirectedFrom=f;let cn;return!E&&kt(s,v,h)&&(cn=on(C.NAVIGATION_DUPLICATED,{to:B,from:v}),Un(v,v,!0,!1)),(cn?Promise.resolve(cn):D(B,v)).catch(H=>G(H)?G(H,C.NAVIGATION_GUARD_REDIRECT)?H:wn(H):jn(H,B,v)).then(H=>{if(H){if(G(H,C.NAVIGATION_GUARD_REDIRECT))return L(S({replace:j},y(H.to),{state:typeof H.to=="object"?S({},w,H.to.state):w,force:E}),f||B)}else H=$(B,v,!0,j,w);return z(B,v,H),H})}function A(l,f){const h=k(l,f);return h?Promise.reject(h):Promise.resolve()}function P(l){const f=fn.values().next().value;return f&&typeof f.runWithContext=="function"?f.runWithContext(l):l()}function D(l,f){let h;const[v,w,E]=Ft(l,f);h=Cn(v.reverse(),"beforeRouteLeave",l,f);for(const x of v)x.leaveGuards.forEach(B=>{h.push(X(B,l,f))});const j=A.bind(null,l,f);return h.push(j),nn(h).then(()=>{h=[];for(const x of r.list())h.push(X(x,l,f));return h.push(j),nn(h)}).then(()=>{h=Cn(w,"beforeRouteUpdate",l,f);for(const x of w)x.updateGuards.forEach(B=>{h.push(X(B,l,f))});return h.push(j),nn(h)}).then(()=>{h=[];for(const x of E)if(x.beforeEnter)if(q(x.beforeEnter))for(const B of x.beforeEnter)h.push(X(B,l,f));else h.push(X(x.beforeEnter,l,f));return h.push(j),nn(h)}).then(()=>(l.matched.forEach(x=>x.enterCallbacks={}),h=Cn(E,"beforeRouteEnter",l,f,P),h.push(j),nn(h))).then(()=>{h=[];for(const x of a.list())h.push(X(x,l,f));return h.push(j),nn(h)}).catch(x=>G(x,C.NAVIGATION_CANCELLED)?x:Promise.reject(x))}function z(l,f,h){d.list().forEach(v=>P(()=>v(l,f,h)))}function $(l,f,h,v,w){const E=k(l,f);if(E)return E;const j=f===J,x=tn?history.state:{};h&&(v||j?o.replace(l.fullPath,S({scroll:j&&x&&x.scroll},w)):o.push(l.fullPath,w)),c.value=l,Un(l,f,h,j),wn()}let W;function yn(){W||(W=o.listen((l,f,h)=>{if(!ln.listening)return;const v=_(l),w=U(v,ln.currentRoute.value);if(w){L(S(w,{replace:!0,force:!0}),v).catch(mn);return}p=v;const E=c.value;tn&&Tt(ne(E.fullPath,h.delta),xn()),D(v,E).catch(j=>G(j,C.NAVIGATION_ABORTED|C.NAVIGATION_CANCELLED)?j:G(j,C.NAVIGATION_GUARD_REDIRECT)?(L(S(y(j.to),{force:!0}),v).then(x=>{G(x,C.NAVIGATION_ABORTED|C.NAVIGATION_DUPLICATED)&&!h.delta&&h.type===Nn.pop&&o.go(-1,!1)}).catch(mn),Promise.reject()):(h.delta&&o.go(-h.delta,!1),jn(j,v,E))).then(j=>{j=j||$(v,E,!1),j&&(h.delta&&!G(j,C.NAVIGATION_CANCELLED)?o.go(-h.delta,!1):h.type===Nn.pop&&G(j,C.NAVIGATION_ABORTED|C.NAVIGATION_DUPLICATED)&&o.go(-1,!1)),z(v,E,j)}).catch(mn)}))}let an=pn(),Y=pn(),V;function jn(l,f,h){wn(l);const v=Y.list();return v.length?v.forEach(w=>w(l,f,h)):console.error(l),Promise.reject(l)}function Me(){return V&&c.value!==J?Promise.resolve():new Promise((l,f)=>{an.add([l,f])})}function wn(l){return V||(V=!l,yn(),an.list().forEach(([f,h])=>l?h(l):f()),an.reset()),l}function Un(l,f,h,v){const{scrollBehavior:w}=n;if(!tn||!w)return Promise.resolve();const E=!h&&Nt(ne(l.fullPath,0))||(v||!h)&&history.state&&history.state.scroll||null;return xe().then(()=>w(l,f,E)).then(j=>j&&Bt(j)).catch(j=>jn(j,l,f))}const Rn=l=>o.go(l);let Pn;const fn=new Set,ln={currentRoute:c,listening:!0,addRoute:m,removeRoute:b,clearRoutes:e.clearRoutes,hasRoute:I,getRoutes:R,resolve:_,options:n,push:M,replace:N,go:Rn,back:()=>Rn(-1),forward:()=>Rn(1),beforeEach:r.add,beforeResolve:a.add,afterEach:d.add,onError:Y.add,isReady:Me,install(l){l.component("RouterLink",cs),l.component("RouterView",ms),l.config.globalProperties.$router=ln,Object.defineProperty(l.config.globalProperties,"$route",{enumerable:!0,get:()=>un(c)}),tn&&!Pn&&c.value===J&&(Pn=!0,M(o.location).catch(v=>{}));const f={};for(const v in J)Object.defineProperty(f,v,{get:()=>c.value[v],enumerable:!0});l.provide(Hn,ln),l.provide(Mn,Ge(f)),l.provide(Vn,c);const h=l.unmount;fn.add(l),l.unmount=function(){fn.delete(l),fn.size<1&&(p=J,W&&W(),W=null,c.value=J,Pn=!1,V=!1),h()}}};function nn(l){return l.reduce((f,h)=>f.then(()=>P(h)),Promise.resolve())}return ln}function hs(n){return Z(Mn)}const fs=[{path:"/",name:"home",component:()=>Kn(()=>import("./HomeView-CP3Fo4ns.js"),__vite__mapDeps([0,1,2,3,4,5,6])),meta:{transition:"page"}},{path:"/article/:slug",name:"article",component:()=>Kn(()=>import("./ArticleView-cT80A6eN.js"),__vite__mapDeps([7,1,2,3,4,5,8])),props:!0,meta:{transition:"page"}},{path:"/tag/:name?",name:"tag",redirect:n=>({path:"/",query:{section:"tags",tag:n.params.name}})}],He=gs({history:Gt(),routes:fs,scrollBehavior(n,e,t){return t||(n.hash?{el:n.hash,behavior:"smooth"}:{top:0,behavior:"smooth"})}}),vs={__name:"App",setup(n){return hs(),(e,t)=>{const s=Ye("router-view");return Wn(),zn(s,null,{default:Gn(({Component:o,route:r})=>[Je(Ke,{name:r.meta.transition||"page",mode:"out-in"},{default:Gn(()=>[(Wn(),zn(Xe(o),{key:r.path}))]),_:2},1032,["name"])]),_:1})}}},bs="fishblog-db",xs=1,rn="analytics";let vn=null;function Fn(){return new Promise((n,e)=>{if(vn){n(vn);return}const t=indexedDB.open(bs,xs);t.onupgradeneeded=()=>{const s=t.result;s.objectStoreNames.contains(rn)||s.createObjectStore(rn,{keyPath:"slug"})},t.onsuccess=()=>{vn=t.result,n(vn)},t.onerror=()=>e(t.error)})}async function ys(){await Fn()}async function mo(n){const e=await Fn();return new Promise((t,s)=>{const a=e.transaction(rn,"readonly").objectStore(rn).get(n);a.onsuccess=()=>t(a.result||null),a.onerror=()=>s(a.error)})}async function go(n){const e=await Fn();return new Promise((t,s)=>{const o=e.transaction(rn,"readwrite");o.objectStore(rn).put({slug:n.slug,viewCount:n.viewCount||0,likeCount:n.likeCount||0,liked:!!n.liked}),o.oncomplete=()=>t(),o.onerror=()=>s(o.error)})}const js=`---
...
# 完结
npm作为前端一个强大的包管理器，在某些方面，它甚至能与maven相提并论，用户不仅可以使用npm下载模块，也可以使用npm分享代码，掌握npm已经成了前端的标配`,Us=`---
...
`,so=new Ze,me=Object.assign({"/src/articles/ASP.NET.md":js,"/src/articles/JSadvanced.md":ws,"/src/articles/Linux-1.md":Rs,"/src/articles/Linux-2.md":Ps,"/src/articles/Linux-3.md":ks,"/src/articles/Linux-4.md":Ss,"/src/articles/Linux-5.md":As,"/src/articles/axios.md":Is,"/src/articles/design.md":_s,"/src/articles/design/CSS动画与孟菲斯设计风格.md":Cs,"/src/articles/echartsOptions.md":Es,"/src/articles/es6.md":Bs,"/src/articles/express.md":Ts,"/src/articles/frontend/Three.js-3D粒子特效实战.md":Ns,"/src/articles/frontend/Vue3-Composition-API完全指南.md":Ls,"/src/articles/git.md":Vs,"/src/articles/http.md":Ds,"/src/articles/jsUtools.md":Os,"/src/articles/markdwon.md":Hs,"/src/articles/network/详解HTTP协议.md":Ms,"/src/articles/nginx.md":Fs,"/src/articles/npm.md":qs,"/src/articles/react.md":Us,"/src/articles/typescript-02.md":zs,"/src/articles/typescript-03.md":Ws,"/src/articles/typescript.md":Gs,"/src/articles/vite.md":$s,"/src/articles/vue-2.md":Ys,"/src/articles/vue-3.md":Js,"/src/articles/vue-4.md":Ks,"/src/articles/vue.md":Xs,"/src/articles/vue3x01.md":Qs,"/src/articles/vue3x02.md":Zs,"/src/articles/vue3x03.md":no,"/src/articles/webpack.md":eo,"/src/articles/yarn.md":to});function oo(n){const e=n.match(/^---\s*\n([\s\S]*?)\n---\s*\n/);if(!e)return{};const t=e[1].split(`
`),s={};let o=null,r=!1,a=!1,d="";for(const c of t){const p=c.trim();if(!p||p.startsWith("#")){a&&o&&(d+=(d?" ":"")+p);continue}const g=p.indexOf(":"),i=/^[a-zA-Z0-9_\-\u4e00-\u9fff]+\s*:/.test(p);if(g===-1||a&&o&&!i){o&&r&&Array.isArray(s[o])?s[o].push(p.replace(/^-\s*/,"").replace(/^`|`$/g,"").trim()):a&&o&&(d+=(d?" ":"")+p.replace(/^`|`$/g,"").trim());continue}const u=p.slice(0,g).trim();let m=p.slice(g+1).trim().replace(/^['"`]|['"`]$/g,"");if(m===">-"||m===">"||m==="|"){o=u,a=!0,r=!1,d="";continue}if(u!==o&&(a&&o&&d&&(s[o]=d.trim(),a=!1,d=""),r&&o&&(r=!1),o=u),m===""||m===">-"||m===">"||m==="|"){if(m===">-"||m===">"||m==="|"){a=!0,r=!1,d="";continue}s[u]=[],r=!0,a=!1;continue}s[u]=m}return a&&o&&d&&(s[o]=d.trim()),s.tags&&typeof s.tags=="string"&&(s.tags=s.tags.split(",").map(c=>c.trim()).filter(Boolean)),s}function ro(n,e=120){const t=n.replace(/[#*`\[\]()!>|-]/g," ").replace(/\s+/g," ").trim();return t.length>e?t.slice(0,e)+"...":t}async function ao(){const n=[];console.log("[md-loader] Found articles:",Object.keys(me).length);for(const[e,t]of Object.entries(me))try{const s=oo(t),o=t.replace(/^---[\s\S]*?---\s*\n/,""),r=so.parse(o),a=e.replace("/src/articles/","").replace(/\.md$/,"");console.log(`[md-loader] ✓ ${a}: ${s.title}`),n.push({slug:a,title:s.title||"Untitled",author:s.author||"FishBand",cover:typeof s.cover=="string"?s.cover.replace(/^`|`$/g,"").trim():"",tags:Array.isArray(s.tags)?s.tags:[],category:s.categories||s.category||"",date:s.date||new Date().toISOString(),abbrlink:s.abbrlink||"",duration:io(o),description:ro(o),content:r,rawBody:o})}catch(s){console.error(`[md-loader] ✗ ERROR parsing ${e}:`,s.message)}return console.log(`[md-loader] Total loaded: ${n.length}`),n.sort((e,t)=>new Date(t.date)-new Date(e.date))}function io(n){const e=(n.match(/[\u4e00-\u9fa5]/g)||[]).length,t=n.replace(/[\u4e00-\u9fa5]/g,"").split(/\s+/).filter(Boolean).length,s=Math.ceil(e*.3+t/200);return s<1?"1 min":`${s} min`}const qn=Qe(vs);qn.use(nt());qn.use(He);He.isReady().then(async()=>{try{await ao(),await ys()}catch(n){console.warn("Init:",n.message)}qn.mount("#app")});export{go as a,po as d,mo as g,ao as l,uo as s,hs as u};
